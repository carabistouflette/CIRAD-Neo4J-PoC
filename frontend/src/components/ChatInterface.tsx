...
export function ChatInterface() {
    ...
    return (
        <div className="flex flex-col h-full lg:h-[700px] bg-neo-white border-3 border-neo-black shadow-neo overflow-hidden">
            {/* Header */}
            <div className="bg-neo-accent p-4 border-b-3 border-neo-black flex items-center gap-3">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-6 bg-neo-bg">
              ...
              ${msg.role === 'assistant' ? 'bg-neo-secondary text-neo-black' : 'bg-neo-primary text-neo-white'}`}>
                ...
                {isLoading && (
                    <div className="flex gap-3">
                        ...
                        <div className="bg-neo-white px-4 py-3 border-2 border-neo-black shadow-neo-sm flex items-center gap-2">
                            <Loader2 className="w-4 h-4 animate-spin text-neo-black" />
                            <span className="text-xs font-bold text-neo-black">Analyse du graphe...</span>
                        </div>
                    </div>
                )}
            </div>
